...
// value of an 8 bit binary numbers are :

//(256, 128, 64, 32, 16, 8, 4, 2, 1).

// Numbers will always be below 1024 (not including 1024).
// The && operator could be useful.
// The strings will always go to the length at which the most left bit's value gets bigger
// than the number in decimal.

function binary(decimal) {
  // console.log(x.toString(2))       // displays '110'
  const x = decimal.toString(2)
  console.log(x)
  return x
}
